...
LR2IR / MinIR / Bokutachi 데이터를 종합해 계산된 데이터입니다. 양쪽 게이지의 중간 정도로 플레이했을 때 추정 난이도로 생각해주시면 되겠습니다. 원본 추정난이도 데이터 범위를 Satellite/Stella 각각의 **이지클리어** 기준 난이도에 선형회귀하는 방식으로 축척만 변경하였습니다.
